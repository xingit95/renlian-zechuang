...
public:
	...
	CLikelyHood	*method1;
	CHairFace   *method2;
	CButtonST   m_btn_open;
	CButtonST   m_btn_likehood;
	CButtonST   m_btn_binary;
	CButtonST   m_btn_mark_face;
	CButtonST   m_btn_edge;
	CButtonST   m_btn_mark_eye;
	CButtonST   m_btn_mark_mouse;
	CButtonST   m_btn_mark_nose;
